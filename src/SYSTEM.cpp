...
namespace SYSTEM
{
  ...
  void UpdateCycle()
  {
    ...
    static uint8_t level = LED_LEVEL_MAX - 1;
  ...
  void CheckInputTune()
  {
    ...
    switch(mRunCmd)
    {
    case CMD_R: incByte(mColor.v[comp]); break;
    case CMD_G: decByte(mColor.v[comp]); break;
    case CMD_FLASH:   mState = STATE_INPUT_CMD; break;
    case CMD_FADE:    mState = STATE_INPUT_HEX; break;
    case CMD_SMOOTH:
